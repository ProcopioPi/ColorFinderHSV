...
namespace VideoSource
{
	...
	public class CaptureDevice : IVideoSource
	{
        ...
        private static CameraEventArgs evt;
		// new frame
		...
		private class Grabber : ISampleGrabberCB
		{
            ...
            private static int dst, src, srcStride, dstStride;
			...
			public int BufferCB(double SampleTime, IntPtr pBuffer, int BufferLen)
			{
				...
				// copy image data
				srcStride = bmData.Stride ;
				dstStride = bmData.Stride;
                
				dst = bmData.Scan0.ToInt32() + dstStride * (height - 1);
				src = pBuffer.ToInt32();

                //bmData.Scan0 = pBuffer;
